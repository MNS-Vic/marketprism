...
from .types import PriceLevel, OrderBookDelta
...
class OKXWebSocketClient:
    ...
    async def start(self):
        ...
        while self.is_running:
            try:
                ...
                self.logger.error("WebSocket连接异常", error=str(e))
                if self.is_running:
    ...
    async def _connect_and_run(self):
        ...
        try:
            ...
            self.logger.error("WebSocket连接错误", error=str(e))
            self.is_connected = False
            raise
    ...
    async def _handle_message(self, message: str):
        ...
        try:
            ...
            self.logger.error("处理WebSocket消息失败", error=str(e), message=message[:200])
    ...
    async def _handle_orderbook_data(self, data: Dict[str, Any]):
        ...
        try:
            ...
            self.logger.error("处理订单簿数据失败", error=str(e), data=str(data)[:200])
    ...
    async def _handle_snapshot(self, symbol: str, data: Dict[str, Any]):
        ...
        try:
            ...
            self.logger.error("处理快照失败", error=str(e), symbol=symbol)
    ...
    async def _handle_update(self, symbol: str, data: Dict[str, Any]):
        ...
        try:
            ...
            self.logger.error("处理增量更新失败", error=str(e), symbol=symbol)
