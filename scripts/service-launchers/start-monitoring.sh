...
# MarketPrism Monitoring Service Launcher
# 监控服务启动脚本
# 端口: 8083
...
SERVICE_PORT=8083
SERVICE_PATH="services/monitoring-service"
SERVICE_MAIN="main.py"
SERVICE_DESCRIPTION="监控服务 - 系统监控、Prometheus指标、智能告警"
...
REQUIRED_PACKAGES=("aiohttp" "pyyaml" "structlog" "prometheus_client" "psutil")
