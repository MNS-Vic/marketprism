...
# 每类表的复制窗口（分钟）
TRADES_WINDOW_MIN=${TRADES_WINDOW_MIN:-10}
ORDERBOOKS_WINDOW_MIN=${ORDERBOOKS_WINDOW_MIN:-10}
LOWFREQ_WINDOW_MIN=${LOWFREQ_WINDOW_MIN:-60}
EVENTS_WINDOW_MIN=${EVENTS_WINDOW_MIN:-60}
