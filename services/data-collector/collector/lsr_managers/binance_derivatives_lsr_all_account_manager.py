"""
Binance衍生品多空持仓人数比例数据管理器（按账户数计算）
...
class BinanceDerivativesLSRAllAccountManager(BaseLSRManager):
    """
    Binance衍生品多空持仓人数比例数据管理器（按账户数计算）
    ...
    def __init__(self,
                 ...
                 config: dict):
        """
        初始化Binance衍生品多空持仓人数比例数据管理器（按账户数计算）
    ...
    async def _normalize_data(self, raw_data: Dict[str, Any]) -> Optional[NormalizedLSRAllAccount]:
        ...
        try:
            ...
            # 使用normalizer进行标准化
            normalized_data = self.normalizer.normalize_binance_lsr_all_account(data_array)
    ...
    def get_manager_info(self) -> Dict[str, Any]:
        ...
        """
        return {
            'manager_type': 'BinanceDerivativesLSRAccountManager',
