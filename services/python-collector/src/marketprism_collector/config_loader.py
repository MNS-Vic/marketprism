...
class ConfigLoader:
    ...
    def load_yaml(self, filename: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("YAML解析失败", file=str(config_path), error=str(e))
            raise
        except Exception as e:
            logger.error("配置文件读取失败", file=str(config_path), error=str(e))
            raise
    ...
    def load_exchange_config(self, exchange_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("交易所配置YAML解析失败", exchange=exchange_name, file=str(config_path), error=str(e))
            raise
        except Exception as e:
            logger.error("交易所配置加载失败", exchange=exchange_name, file=str(config_path), error=str(e))
            raise
