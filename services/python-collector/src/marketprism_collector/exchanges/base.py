...
class ExchangeAdapter(ABC):
    ...
    async def _ping_maintenance_loop(self):
        ...
        while self.is_connected:
            try:
                ...
                self.logger.error("Ping维护循环错误", error=str(e))
    ...
    async def _check_pong_timeout(self):
        ...
        try:
            ...
            self.logger.error("Pong超时检查失败", error=str(e))
    ...
    def _calculate_health_score(self) -> int:
        ...
        if self.stats['last_message_time']:
            time_since_last_message = (datetime.utcnow() - self.stats['last_message_time']).total_seconds()
