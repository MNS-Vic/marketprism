...
class OKXAdapter(ExchangeAdapter):
    ...
    async def start(self) -> bool:
        ...
        try:
            ...
            self.logger.error("启动OKX适配器失败", error=str(e))
            return False
    ...
    async def stop(self):
        ...
        try:
            ...
            self.logger.error("停止OKX适配器失败", error=str(e))
    ...
    async def _start_okx_maintenance_tasks(self):
        ...
        try:
            ...
            self.logger.error("启动OKX维持任务失败", error=str(e))
    ...
    async def _stop_okx_maintenance_tasks(self):
        ...
        try:
            ...
            self.logger.error("停止OKX维持任务失败", error=str(e))
    ...
    async def _data_monitor_loop(self):
        ...
        while self.is_connected:
            try:
                ...
                self.logger.error("OKX数据监控失败", error=str(e))
    ...
    async def _process_enhanced_message(self, message: str):
        ...
        try:
            ...
            self.logger.error("处理OKX增强消息失败", error=str(e), message=message[:200])
    ...
    async def _send_exchange_ping(self):
        ...
        try:
            ...
            self.logger.error("发送OKX ping失败", error=str(e))
    ...
    async def add_symbol_subscription(self, symbol: str, data_types: List[str]):
        ...
        try:
            ...
            self.logger.error("添加OKX订阅失败", symbol=symbol, error=str(e))
    ...
    async def remove_symbol_subscription(self, symbol: str, data_types: List[str]):
        ...
        try:
            ...
            self.logger.error("移除OKX订阅失败", symbol=symbol, error=str(e))
